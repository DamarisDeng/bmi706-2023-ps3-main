...
year = st.slider("Year", min_value=2000, max_value=2018, value=2018, step=1)
...
sex = st.radio(label="Sex", options=["M", "F"], index=0)
...
countries = st.multiselect("Country", options=countries, default=countries)
...
cancer = st.selectbox("Cancer", options=df["Cancer"].unique(), index=0)
